...
const CONST = {
    // 포트이름 설정
    portName: process.platform.startsWith('win') ? "COM6" : "%%SERIALPORT%%",
    // SerialPort 전송 Delay(ms)
    sendDelay: 150,
    // MQTT 브로커
    mqttBroker: 'mqtt://%%MQTTHOST%%', // *************** 환경에 맞게 수정하세요! **************
    // MQTT 수신 Delay(ms)
    mqttDelay: 1000*10,

    mqttUser: '%%MQTTUSER%%',  // *************** 환경에 맞게 수정하세요! **************
    mqttPass: '%%MQTTPASSWORD%%', // *************** 환경에 맞게 수정하세요! **************
